...
// CS 3500
// 2019 October
// Originally written by Joe Zachary for CS 3500, September 2011.
...
namespace SS
{
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        public void ActivateLightMode()
        {
            ...
            drawingPanel.ActivateLightMode();
        }
        ...
        private class DrawingPanel : Panel
        {
            ...
            /// <summary>
            /// activate dark mode for the drawing panel.
            /// updates the current background and foreground colors used when painting the panel.
            /// </summary>
            public void ActivateDarkMode()
            {
            ...
            /// <summary>
            /// returns what the background color is depending on if the panel is currently set to dark or light mode
            /// </summary>
            ...
            /// <summary>
            /// returns what the foreground color is depending on if the panel is currently set to dark or light mode
            /// </summary>
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                e.Graphics.FillRectangle(
                    new SolidBrush(GetCurrentBackgroundColor()),
                    LABEL_COL_WIDTH,
                    LABEL_ROW_HEIGHT,
                ...
                Brush brush = new SolidBrush(GetCurrentForegroundColor());
            ...
            private void DrawColumnLabel(Graphics g, int x, Font f)
            {
                ...
                g.DrawString(
                      label,
                      f,
                      new SolidBrush(GetCurrentForegroundColor()),
